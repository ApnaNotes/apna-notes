...
const heroStats: { label: string; value: string }[] = [
  { label: "Notes uploaded", value: "320+" },
  { label: "Avg connect time", value: "8m" },
  { label: "Mentors onboarded", value: "120+" },
];
...
export function GlowyWavesHero() {
  ...
  useEffect(() => {
    ...
    const computeThemeColors = () => {
      ...
      // Convert CSS variables to concrete rgba/rgb values for canvas rendering.
    ...
    const drawWave = (wave: WaveConfig) => {
      ...
      const drawStep = isLowPowerMode ? 8 : 4;

      for (let x = 0; x <= canvas.width; x += drawStep) {
      ...
      ctx.shadowBlur = isLowPowerMode ? 14 : 35;
    ...
    const animate = () => {
      ...
      const wavesToDraw = isLowPowerMode
        ? themeColors.wavePalette.slice(0, 3)
        : themeColors.wavePalette;
      wavesToDraw.forEach(drawWave);
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          ...
          >
            Get structured notes for UPSC, JEE, NEET, and Boards, and learn
            directly from toppers through 1 on 1 guidance.
          </motion.p>
